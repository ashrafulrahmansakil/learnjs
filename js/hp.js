...
Example: var strType = `hablu programmer`;
...
Example: var BoolType = "true";
console.log(BoolType);
console.log(typeof BoolType);

Example: var BoolType = "false";
console.log(BoolType);
console.log(typeof BoolType);
...
Example: toUppercase: var quotes =
...
Example: var lotary = Math.random();
console.log(sum);

var lotary = Math.random() * console.log(sum);
